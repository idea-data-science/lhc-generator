...
//bzw ist alles der std library automatisch verfügbar und wenn ja warum musste man
//hier vector extra includen?
...
int main(int argc, char *argv[]) {
  ...
  size_t number_of_points, number_of_dimensions; //definiert zwei variablen des typs "size_t" https://en.cppreference.com/w/c/types/size_t
...
//ABSL_MUST_USE_RESULT bool SimpleAtoi(absl::string_view str, int_type* out);
  ...
  if (!absl::SimpleAtoi(argv[1], &number_of_points)) { //Zweites Argument der Funktion ist der Speicherort
  ...
  for (size_t d = 0; d < number_of_dimensions; ++d) {
    ...
    X.push_back(x); //https://www.cplusplus.com/reference/vector/vector/push_back/
  }
